import AbstractFileManager from '../core/environment/abstract-file-manager.js';
...
FileManager.prototype = Object.assign(new AbstractFileManager(), {
    ...
    doXHRSync(url, type, callback, errback) {
    ...
    loadFileSync(filename, currentDirectory, options, environment) {
        ...
        if (options.useFileCache && fileCache[href]) {
            try {
                ...
                return { contents: lessText, filename: href, webInfo: { lastModified: new Date() }};
            } catch (e) {
                throw new Error(`Error loading file ${href} error was ${e.message}`);
            }
        }
        ...
        self.doXHR(href, options.mime, function doXHRCallback(data, lastModified) {
            ...
            result = { contents: data, filename: href, webInfo: { lastModified }};
        }, function doXHRError(status, url) {
            throw new Error(`'${url}' wasn't found (${status})`);
        });
        return result
    },
